...
class ChangeOffVariationAction : AnAction {
    ...
    companion object {
        const val ID = "com.github.intheclouddan.intellijpluginld.action.ChangeOffVariationAction"
    }
    ...
    override fun update(e: AnActionEvent) {
        ...
        if (project != null) {
            if (project.service<FlagToolWindow>().getPanel().tree.lastSelectedPathComponent != null) {
                ...
                e.presentation.isEnabledAndVisible = e.presentation.isEnabled && (selectedNode.startsWith("Off Variation:"))
            }
        }
    }
}